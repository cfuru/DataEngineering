...
- `Databricks/Notebooks/utils/udf_helpers.ipynb` - New UDF definition notebook that registers Python functions as Spark SQL UDFs.
- `Databricks/Notebooks/silver/soldObjects.ipynb` - Existing pipeline notebook to be refactored to use the registered SQL UDFs.
- `Databricks/Notebooks/utils/pipeline_helpers.py` - Existing helper module with transformation functions (will be delegated to by UDFs).
- `tests/test_pipeline_helpers.py` - Existing unit test file; will be updated with new test coverage for transformation functions.

### Notes

- Unit tests should be run with `pytest tests/test_pipeline_helpers.py` from the repository root.
...
- [ ] 1.0 Create UDF Definition Notebook
  - [ ] 1.1 Create `Databricks/Notebooks/utils/udf_helpers.ipynb` file
...
- [ ] 3.0 Add Unit Test Coverage
  - [ ] 3.1 Open `tests/test_pipeline_helpers.py` and review existing tests
  ...
  - [ ] 3.5 Run `pytest tests/test_pipeline_helpers.py` and verify all tests pass locally

- [ ] 4.0 Refactor SoldObjects Notebook
  - [ ] 4.1 Open `Databricks/Notebooks/silver/soldObjects.ipynb`
...
- [ ] 6.0 Finalize and Merge
  - [ ] 6.1 Run full test suite: `pytest tests/test_pipeline_helpers.py`
